...
SUPPORT_CHAT_ID = int(environ.get("SUPPORT_CHAT_ID", "-1001885771153"))
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '+NwkkJ6e9r4hjMGJl')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "True")), False)
IMDB = is_enabled((environ.get('IMDB', "False")), True)
AUTO_FFILTER = is_enabled((environ.get('AUTO_FFILTER', "True")), True)
AUTO_DELETE = is_enabled((environ.get('AUTO_DELETE', "True")), True)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "True")), True)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", '<a href="https://t.me/+K0j5JK0rUvc2N2I1">{file_name} \n\n <b>☞</b> [𝙅𝙏𝙕𝙊𝙉𝙀 ❤️‍🔥](https://t.me/+K0j5JK0rUvc2N2I1)\n <b>☞</b> [𝘼𝘿𝙐𝙇𝙏 🔞](https://t.me/+wNjhglbu6ZIxMTQ1)')
